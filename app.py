...
# --------------------------------------------------
# PDF GENERATOR (ENTERPRISE VERSION)
# --------------------------------------------------
def generate_pdf_report(result, license_key):
    ...
    pdf.cell(0, 8, f"Confidence Score: {result['confidence']:.2f}%", ln=True)
    pdf.ln(15)
    ...
    pdf.cell(0, 6, "Confidential Report - Enterprise AI Systems", ln=True, align="C")
    pdf.cell(0, 6, "Generated by Secure AI Assessment Engine", ln=True, align="C")
    pdf.cell(0, 6, f"© {datetime.datetime.now().year} Enterprise AI Systems", ln=True, align="C")
...
if not logs_df.empty:
    fig = px.pie(logs_df, names="decision", title="Eligibility Rate")
